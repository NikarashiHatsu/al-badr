        ...
        <div class="classes-sec">
            <div class="row classes-carousel">
                <div class="col-lg-3">
                    <div class="classes-col wow fadeInUp" data-wow-duration="1000ms">
                        <div class="class-thumb">
                            <img src="<?= asset('assets/ratb/abdul_ghofar.jpeg') ?>" alt="" class="w-100" style="height: 400px !important">
                        </div>
                ...
                <div class="col-lg-3">
                    <div class="classes-col wow fadeInUp" data-wow-duration="1000ms">
                        <div class="class-thumb">
                            <img src="<?= asset('assets/ratb/ropiqoh.jpeg') ?>" alt="" class="w-100" style="height: 400px !important">
                        </div>
                        <div class="class-info">
                ...
                <div class="col-lg-3">
                    <div class="classes-col wow fadeInUp" data-wow-duration="1000ms">
                        <div class="class-thumb">
                            <img src="<?= asset('assets/ratb/marzujah.jpeg') ?>" alt="" class="w-100" style="height: 400px !important">
                        </div>
                        <div class="class-info">
                            <h3>Marzujah, S.Pd</h3>
                ...
                <div class="col-lg-3">
                    <div class="classes-col wow fadeInUp" data-wow-duration="1000ms">
                        <div class="class-thumb">
                            <img src="<?= asset('assets/ratb/sumira.jpeg') ?>" alt="" class="w-100" style="height: 400px !important">
                        </div>
                        <div class="class-info">
                            <h3>Sumira, S.Pd</h3>
                            <p>Crb, 05 Mei 1976</p>
                ...
                <div class="col-lg-3">
                    <div class="classes-col wow fadeInUp" data-wow-duration="1000ms">
                        <div class="class-thumb">
                            <img src="<?= asset('assets/ratb/saeni.jpeg') ?>" alt="" class="w-100" style="height: 400px !important">
                        </div>
                        <div class="class-info">
                            <h3>Saeni, S.Pd.I</h3>
                ...
                <div class="col-lg-3">
                    <div class="classes-col wow fadeInUp" data-wow-duration="1000ms">
                        <div class="class-thumb">
                            <img src="<?= asset('assets/ratb/siti_saomi.jpeg') ?>" alt="" class="w-100" style="height: 400px !important">
                        </div>
                        <div class="class-info">
                ...
                <div class="col-lg-3">
                    <div class="classes-col wow fadeInUp" data-wow-duration="1000ms">
                        <div class="class-thumb">
                            <img src="<?= asset('assets/ratb/yayah_fitriyah.jpeg') ?>" alt="" class="w-100" style="height: 400px !important">
                        </div>
                        <div class="class-info">
                ...
                <div class="col-lg-3">
                    <div class="classes-col wow fadeInUp" data-wow-duration="1000ms">
                        <div class="class-thumb">
                            <img src="<?= asset('assets/ratb/fatihah.jpeg') ?>" alt="" class="w-100" style="height: 400px !important">
                        </div>
                        <div class="class-info">
                ...
                <div class="col-lg-3">
                    <div class="classes-col wow fadeInUp" data-wow-duration="1000ms">
                        <div class="class-thumb">
                            <img src="<?= asset('assets/ratb/ekawati.jpeg') ?>" alt="" class="w-100" style="height: 400px !important">
                        </div>
                        <div class="class-info">
                ...
                <div class="col-lg-3">
                    <div class="classes-col wow fadeInUp" data-wow-duration="1000ms">
                        <div class="class-thumb">
                            <img src="<?= asset('assets/ratb/masnuah.jpeg') ?>" alt="" class="w-100" style="height: 400px !important">
                        </div>
                        <div class="class-info">
                            <h3>Masnuah</h3>
                ...
                <div class="col-lg-3">
                    <div class="classes-col wow fadeInUp" data-wow-duration="1000ms">
                        <div class="class-thumb">
                            <img src="<?= asset('assets/ratb/ina_dwi_riyani.jpeg') ?>" alt="" class="w-100" style="height: 400px !important">
                        </div>
                        <div class="class-info">
                ...
                <div class="col-lg-3">
                    <div class="classes-col wow fadeInUp" data-wow-duration="1000ms">
                        <div class="class-thumb">
                            <img src="<?= asset('assets/ratb/irma.jpeg') ?>" alt="" class="w-100" style="height: 400px !important">
                        </div>
                        <div class="class-info">
                            <h3>Irma</h3>
                ...
                <div class="col-lg-3">
                    <div class="classes-col wow fadeInUp" data-wow-duration="1000ms">
                        <div class="class-thumb">
                            <img src="<?= asset('assets/ratb/zidny_farhatal_aisy.jpeg') ?>" alt="" class="w-100" style="height: 400px !important">
                        </div>
                        <div class="class-info">
                ...
                <div class="col-lg-3">
                    <div class="classes-col wow fadeInUp" data-wow-duration="1000ms">
                        <div class="class-thumb">
                            <img src="<?= asset('assets/ratb/nur_fatimah.jpeg') ?>" alt="" class="w-100" style="height: 400px !important">
                        </div>
                        <div class="class-info">
                ...
                <div class="col-lg-3">
                    <div class="classes-col wow fadeInUp" data-wow-duration="1000ms">
                        <div class="class-thumb">
                            <img src="<?= asset('assets/ratb/gina_shabrina_bar.jpeg') ?>" alt="" class="w-100" style="height: 400px !important">
                        </div>
                        <div class="class-info">
                ...
                <div class="col-lg-3">
                    <div class="classes-col wow fadeInUp" data-wow-duration="1000ms">
                        <div class="class-thumb">
                            <img src="<?= asset('assets/ratb/nur_fitriani.jpeg') ?>" alt="" class="w-100" style="height: 400px !important">
                        </div>
                        <div class="class-info">
